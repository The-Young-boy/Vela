...
object AppLocale {
     ...
     *  table in :core. */
    // "iw" (not "he") — Java's Locale normalizes "he" → "iw", so the resolved language code, the
    // res/values-iw folder, and NavStrings.forLanguage all agree on "iw".
    val SUPPORTED = listOf("en", "fr", "de", "es", "it", "pt", "nl", "ru", "pl", "sv", "uk", "iw")
    ...
    private val ENDONYMS = mapOf(
        ...
        "pl" to "Polski", "sv" to "Svenska", "uk" to "Українська", "iw" to "עברית",
    )
