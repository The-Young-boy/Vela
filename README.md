...
- **Real turn-by-turn navigation.** Spoken directions from a neural voice that runs
  ...
  🔊 **[Hear the nav voice](docs/voice-demo.wav)** - that's the actual in-app voice
  (HFC Female at the default pace), generated by the same engine the app runs on the phone.
